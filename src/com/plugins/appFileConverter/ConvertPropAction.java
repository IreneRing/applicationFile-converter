 ...
 * @author xqchen
 */
public class ConvertPropAction extends AnAction {
    ...
    public void update(@NotNull AnActionEvent event) {
        ...
        //根据类型动态控制Action的隐藏显示
        //yaml类型和不存在prop
        event.getPresentation().setEnabledAndVisible(CommonUtils.containFileType(event, Constant.YAML) && presentation.isEnabled() && !CommonUtils.isSameFileName(event));
