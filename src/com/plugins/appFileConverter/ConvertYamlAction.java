 ...
 * @author zxy
 */
public class ConvertYamlAction extends AnAction {
    ...
    public void update(@NotNull AnActionEvent event) {
        ...
        //根据类型动态控制Action的隐藏显示
        //prop类型和不存在yaml
        event.getPresentation().setEnabledAndVisible(CommonUtils.containFileType(event, Constant.PROPERTIES) && presentation.isEnabled() && !CommonUtils.isSameFileName(event));
